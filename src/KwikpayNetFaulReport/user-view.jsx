...
import { AllNetFailResponse } from '../_mock/Kwikpay';
...
export default function KwikpayNetFailedReport() {
...
useEffect(()=>{
  AllNetFailResponse(startDate,endDate).then((res)=>{
    setMachines(res);
   })
  ...
  return <>
    ...
    <Container maxWidth="xxl">
      ...
      <Stack direction="row" alignItems="center" justifyContent="space-between" mb={5}>
        <Typography variant="h5">Kwikpay Network Failed Time Period</Typography>
